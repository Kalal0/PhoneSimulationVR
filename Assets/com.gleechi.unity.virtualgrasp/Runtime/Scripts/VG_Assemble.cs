...
namespace VirtualGrasp.Scripts
{
    ...
    {
        public bool thisIsOnlyTrueOnTheFirstRun=true;
        public bool thisIsOnlyTrueOnTheFirstRun2 = false;
        ...
        bool isZeroState(VG_JointType jointType)
        {
            ...
            {
                if(thisIsOnlyTrueOnTheFirstRun==true)
                    return jointState == -360.0F;
                else if(thisIsOnlyTrueOnTheFirstRun2==true)
                    return jointState == 360.0F;
                else
